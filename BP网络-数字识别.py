...
class NeuralNetwork:
    def __init__(self, layers):  # layers:(输入神经元数，隐藏层神经元数，输出层神经元数)
...
labels_train = LabelBinarizer().fit_transform(y_train)  # 化为二进制
labels_test = LabelBinarizer().fit_transform(y_test)  # 化为二进制
